...
// 	testDiscovery = virtual.DiscoveryOptions{
...
// 	}
// 	defaultOptsGoByte = virtual.EnvironmentOptions{
// 		Discovery:                              testDiscovery,
// 		CustomHostFns:                          customHostFns,
// 		GCActorsAfterDurationWithNoInvocations: testGCActorsAfterDurationWithNoInvocations,
// 	}
// 	defaultOptsGoStream = virtual.EnvironmentOptions{
// 		Discovery:                              testDiscovery,
// 		CustomHostFns:                          customHostFns,
// 		GCActorsAfterDurationWithNoInvocations: testGCActorsAfterDurationWithNoInvocations,
// 	}
// 	defaultOptsGoDNS = virtual.EnvironmentOptions{
// 		CustomHostFns:                          customHostFns,
// 		GCActorsAfterDurationWithNoInvocations: testGCActorsAfterDurationWithNoInvocations,
// 	}
// )
...
// 	testFn := func(t *testing.T, reg registry.Registry, env virtual.Environment) {
...
// 	env1, err := virtual.NewEnvironment(ctx, "serverID1", reg, moduleStore, nil, opts1)
// 	require.NoError(t, err)
// 	defer env1.Close(context.Background())

// 	opts2 := defaultOptsWASM
// 	opts2.Discovery.Port = 2
// 	env2, err := virtual.NewEnvironment(ctx, "serverID2", reg, moduleStore, nil, opts2)
// 	require.NoError(t, err)
// 	defer env2.Close(context.Background())

// 	opts3 := defaultOptsWASM
// 	opts3.Discovery.Port = 3
// 	env3, err := virtual.NewEnvironment(ctx, "serverID3", reg, moduleStore, nil, opts3)
// 	require.NoError(t, err)
...
// 		moduleStore = newTestModuleStore()
// 	)
// 	env, err := virtual.NewEnvironment(context.Background(), "serverID1", reg, moduleStore, nil, defaultOptsGoByte)
// 	require.NoError(t, err)
...
// 	env, err := virtual.NewEnvironment(ctx, "serverID1", reg, moduleStore, nil, opts)
// 	require.NoError(t, err)
...
// 	testFnAfterClose := func(t *testing.T, reg registry.Registry, env virtual.Environment) {
...
// 			moduleStore = newTestModuleStore()
// 		)
// 		env, err := virtual.NewEnvironment(context.Background(), "serverID1", reg, moduleStore, nil, opts)
// 		require.NoError(t, err)
// 		defer func() { noErrIgnoreDupeClose(t, env.Close(context.Background())) }()
...
// 		// 	context.Background(), &testLeaderProvider{}, "serverID1", 9093, virtual.EnvironmentOptions{})
// 		// require.NoError(t, err)
// 		// env, err := virtual.NewEnvironment(context.Background(), "serverID1", reg, newTestModuleStore(), nil, opts)
// 		// require.NoError(t, err)
// 		// defer func() { noErrIgnoreDupeClose(t, env.Close(context.Background())) }()
